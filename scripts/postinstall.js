...
// into it. bin/talk-to-type.js then runs that venv's Python directly.
"use strict";
...
function fail(message) {
  console.error(`\ntalk-to-type install failed: ${message}\n`);
  process.exit(1);
}
...
function main() {
  ...
  console.log("whatever app runs `talk-to-type` (Terminal, iTerm, etc.):");
  console.log("  - Microphone");
  console.log("  - Accessibility");
  console.log("  - Input Monitoring");
  console.log("\nRun `talk-to-type` and it'll tell you exactly what's missing.\n");
}
